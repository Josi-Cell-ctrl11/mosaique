...
-- ============================================================
-- SAUCES ASSROKOUIN, SAUCES GOMBO, SAUCE ARACHIDE, MICHoui MOUTON
-- Visuels locaux du site : /assets/menu/
-- ============================================================
insert into public.categories (id, nom, slug, ordre) values
  ('a0000010-0000-0000-0000-000000000010', 'Sauces assrokouin', 'sauces-assrokouin', 10),
  ('a0000011-0000-0000-0000-000000000011', 'Sauces gombo',      'sauces-gombo',      11),
  ('a0000012-0000-0000-0000-000000000012', 'Sauce arachide',    'sauce-arachide',    12),
  ('a0000013-0000-0000-0000-000000000013', 'Michoui mouton',    'michoui-mouton',    13);
...
('a0000010-0000-0000-0000-000000000010', 'Sauce assrokouin enrichie — viande de mouton', 'assrokouin-mouton', 'Sauce assrokouin enrichie au mouton, crabe, couenne de bœuf et fromage.', 'Viande de mouton, crabe, couenne de bœuf, fromage', 4500, true, false, false, false, 1, '/assets/menu/sauce-assrokouin.jpeg'),
('a0000010-0000-0000-0000-000000000010', 'Sauce assrokouin enrichie — viande de bœuf', 'assrokouin-boeuf', 'Sauce assrokouin enrichie au bœuf, crabe, couenne de bœuf et fromage.', 'Viande de bœuf, crabe, couenne de bœuf, fromage', 6000, true, false, false, false, 2, '/assets/menu/sauce-assrokouin.jpeg'),
('a0000010-0000-0000-0000-000000000010', 'Sauce assrokouin enrichie — viande de poulet', 'assrokouin-poulet', 'Sauce assrokouin enrichie au poulet, crabe, couenne de bœuf et fromage.', 'Viande de poulet, crabe, couenne de bœuf, fromage', 4500, true, false, false, false, 3, '/assets/menu/sauce-assrokouin.jpeg'),
('a0000010-0000-0000-0000-000000000010', 'Sauce assrokouin enrichie — poisson fumé', 'assrokouin-poisson-fume', 'Sauce assrokouin enrichie au poisson fumé, crabe, couenne de bœuf et fromage.', 'Poisson fumé, crabe, couenne de bœuf, fromage', 3500, true, false, false, false, 4, '/assets/menu/sauce-assrokouin.jpeg'),
('a0000010-0000-0000-0000-000000000010', 'Sauce assrokouin double viande', 'assrokouin-double-viande', 'Sauce assrokouin double viande avec crabe, couenne de bœuf, fromage, huile rouge et feuilles de grand morel.', 'Viande de mouton, viande de bœuf, crabe, couenne de bœuf, fromage, huile rouge, feuilles de grand morel', 8000, true, false, false, false, 5, '/assets/menu/sauce-assrokouin.jpeg'),
('a0000010-0000-0000-0000-000000000010', 'Sauce assrokouin enrichie — tripes de mouton', 'assrokouin-tripes-mouton', 'Sauce assrokouin enrichie aux tripes de mouton.', 'Tripes de mouton', 5000, true, false, false, false, 6, '/assets/menu/sauce-assrokouin.jpeg'),
('a0000010-0000-0000-0000-000000000010', 'Sauce assrokouin — tripes de bœuf', 'assrokouin-tripes-boeuf', 'Sauce assrokouin aux tripes de bœuf.', 'Tripes de bœuf', 4500, true, false, false, false, 7, '/assets/menu/sauce-assrokouin.jpeg'),
('a0000011-0000-0000-0000-000000000011', 'Sauce gombo enrichie — viande de mouton', 'gombo-mouton', 'Sauce gombo enrichie au mouton, crabe, couenne de bœuf et fromage.', 'Viande de mouton, crabe, couenne de bœuf, fromage', 4500, true, false, false, false, 1, '/assets/menu/sauce-gombo.jpeg'),
('a0000011-0000-0000-0000-000000000011', 'Sauce gombo enrichie — viande de bœuf', 'gombo-boeuf', 'Sauce gombo enrichie au bœuf, crabe, couenne de bœuf et fromage.', 'Viande de bœuf, crabe, couenne de bœuf, fromage', 6000, true, false, false, false, 2, '/assets/menu/sauce-gombo.jpeg'),
('a0000011-0000-0000-0000-000000000011', 'Sauce gombo enrichie — viande de poulet', 'gombo-poulet', 'Sauce gombo enrichie au poulet, crabe, couenne de bœuf et fromage.', 'Viande de poulet, crabe, couenne de bœuf, fromage', 4500, true, false, false, false, 3, '/assets/menu/sauce-gombo.jpeg'),
('a0000011-0000-0000-0000-000000000011', 'Sauce gombo enrichie — poisson fumé', 'gombo-poisson-fume', 'Sauce gombo enrichie au poisson fumé, crabe, couenne de bœuf et fromage.', 'Poisson fumé, crabe, couenne de bœuf, fromage', 3500, true, false, false, false, 4, '/assets/menu/sauce-gombo.jpeg'),
('a0000011-0000-0000-0000-000000000011', 'Sauce gombo double viande', 'gombo-double-viande', 'Sauce gombo double viande avec crabe, couenne de bœuf, fromage, huile rouge et feuilles de grand morel.', 'Viande de mouton, viande de bœuf, crabe, couenne de bœuf, fromage, huile rouge, feuilles de grand morel', 8000, true, false, false, false, 5, '/assets/menu/sauce-gombo.jpeg'),
('a0000011-0000-0000-0000-000000000011', 'Sauce gombo enrichie — tripes de mouton', 'gombo-tripes-mouton', 'Sauce gombo enrichie aux tripes de mouton.', 'Tripes de mouton', 5000, true, false, false, false, 6, '/assets/menu/sauce-gombo.jpeg'),
('a0000011-0000-0000-0000-000000000011', 'Sauce gombo — tripes de bœuf', 'gombo-tripes-boeuf', 'Sauce gombo aux tripes de bœuf.', 'Tripes de bœuf', 4500, true, false, false, false, 7, '/assets/menu/sauce-gombo.jpeg'),
('a0000012-0000-0000-0000-000000000012', 'Sauce d’arachide enrichie — viande de mouton', 'arachide-mouton', 'Sauce d’arachide enrichie à la viande de mouton et au fromage.', 'Viande de mouton, fromage', 5000, true, false, false, false, 1, '/assets/menu/sauce-arachide.jpeg'),
('a0000012-0000-0000-0000-000000000012', 'Sauce d’arachide enrichie — viande de bœuf', 'arachide-boeuf', 'Sauce d’arachide enrichie à la viande de bœuf et au fromage.', 'Viande de bœuf, fromage', 5500, true, false, false, false, 2, '/assets/menu/sauce-arachide.jpeg'),
('a0000012-0000-0000-0000-000000000012', 'Sauce d’arachide enrichie — viande de poulet', 'arachide-poulet', 'Sauce d’arachide enrichie à la viande de poulet et au fromage.', 'Viande de poulet, fromage', 4500, true, false, false, false, 3, '/assets/menu/sauce-arachide.jpeg'),
('a0000012-0000-0000-0000-000000000012', 'Sauce d’arachide enrichie — poisson fumé et bœuf', 'arachide-poisson-fume-boeuf', 'Sauce d’arachide enrichie au poisson fumé, à la viande de bœuf et au fromage.', 'Poisson fumé, viande de bœuf, fromage', 6000, true, false, false, false, 4, '/assets/menu/sauce-arachide.jpeg'),
('a0000012-0000-0000-0000-000000000012', 'Sauce d’arachide enrichie — poisson fumé et mouton', 'arachide-poisson-fume-mouton', 'Sauce d’arachide enrichie au poisson fumé, à la viande de mouton et aux fromages.', 'Poisson fumé, viande de mouton, fromages', 5500, true, false, false, false, 5, '/assets/menu/sauce-arachide.jpeg'),
('a0000012-0000-0000-0000-000000000012', 'Sauce d’arachide — mouton et bœuf', 'arachide-mouton-boeuf', 'Sauce d’arachide à la viande de mouton et de bœuf.', 'Viande de mouton, viande de bœuf', 7000, true, false, false, false, 6, '/assets/menu/sauce-arachide.jpeg'),
('a0000012-0000-0000-0000-000000000012', 'Sauce d’arachide enrichie — tripes de mouton', 'arachide-tripes-mouton', 'Sauce d’arachide enrichie aux tripes de mouton.', 'Tripes de mouton', 5000, true, false, false, false, 7, '/assets/menu/sauce-arachide.jpeg'),
('a0000012-0000-0000-0000-000000000012', 'Sauce d’arachide enrichie — tripes de bœuf', 'arachide-tripes-boeuf', 'Sauce d’arachide enrichie aux tripes de bœuf.', 'Tripes de bœuf', 4500, true, false, false, false, 8, '/assets/menu/sauce-arachide.jpeg'),
('a0000013-0000-0000-0000-000000000013', 'Michoui de mouton entier', 'michoui-mouton-entier', 'Michoui de mouton entier, préparé pour une grande commande.', 'Mouton entier', 85000, true, false, false, false, 1, '/assets/menu/michoui-mouton.jpeg'),
('a0000013-0000-0000-0000-000000000013', 'Michoui de demi-mouton', 'michoui-demi-mouton', 'Michoui de demi-mouton, préparé pour une commande généreuse.', 'Demi-mouton', 43000, true, false, false, false, 2, '/assets/menu/michoui-mouton.jpeg'),
('a0000013-0000-0000-0000-000000000013', 'Michoui de cas de mouton', 'michoui-cas-mouton', 'Préparation de mouton selon le format indiqué sur le menu source.', 'Cas de mouton — libellé à confirmer', 22000, true, false, false, false, 3, '/assets/menu/michoui-mouton.jpeg'),
('a0000013-0000-0000-0000-000000000013', 'Michoui de mouton et sauce gbôta', 'michoui-mouton-sauce-gbota', 'Michoui de mouton accompagné de sauce gbôta.', 'Mouton, sauce gbôta', 120000, true, false, false, false, 4, '/assets/menu/michoui-mouton.jpeg'),
