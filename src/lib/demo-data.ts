...
export const CATEGORIES_DEMO: Categorie[] = [
  ...
  { id: 'cat-10', nom: 'Sauces assrokouin', slug: 'sauces-assrokouin', ordre: 10, created_at: '' },
...
export const PLATS_DEMO: Plat[] = [
  ...
  // ── SAUCES ASSROKOUIN ───────────────────────────────────────
  { id: 'd-a01', categorie_id: 'cat-10', nom: 'Sauce assrokouin enrichie — viande de mouton', slug: 'assrokouin-mouton', description: 'Sauce assrokouin enrichie au mouton, crabe, couenne de bœuf et fromage.', prix: 4500, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 1, images_urls: [], created_at: d, updated_at: d },
  { id: 'd-a02', categorie_id: 'cat-10', nom: 'Sauce assrokouin enrichie — viande de bœuf', slug: 'assrokouin-boeuf', description: 'Sauce assrokouin enrichie au bœuf, crabe, couenne de bœuf et fromage.', prix: 6000, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 2, images_urls: [], created_at: d, updated_at: d },
  { id: 'd-a03', categorie_id: 'cat-10', nom: 'Sauce assrokouin enrichie — viande de poulet', slug: 'assrokouin-poulet', description: 'Sauce assrokouin enrichie au poulet, crabe, couenne de bœuf et fromage.', prix: 4500, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 3, images_urls: [], created_at: d, updated_at: d },
  { id: 'd-a04', categorie_id: 'cat-10', nom: 'Sauce assrokouin enrichie — poisson fumé', slug: 'assrokouin-poisson-fume', description: 'Sauce assrokouin enrichie au poisson fumé, crabe, couenne de bœuf et fromage.', prix: 3500, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 4, images_urls: [], created_at: d, updated_at: d },
  { id: 'd-a05', categorie_id: 'cat-10', nom: 'Sauce assrokouin double viande', slug: 'assrokouin-double-viande', description: 'Sauce assrokouin double viande avec crabe, couenne de bœuf, fromage, huile rouge et feuilles de grand morel.', prix: 8000, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 5, images_urls: [], created_at: d, updated_at: d },
  { id: 'd-a06', categorie_id: 'cat-10', nom: 'Sauce assrokouin enrichie — tripes de mouton', slug: 'assrokouin-tripes-mouton', description: 'Sauce assrokouin enrichie aux tripes de mouton.', prix: 5000, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 6, images_urls: [], created_at: d, updated_at: d },
  { id: 'd-a07', categorie_id: 'cat-10', nom: 'Sauce assrokouin — tripes de bœuf', slug: 'assrokouin-tripes-boeuf', description: 'Sauce assrokouin aux tripes de bœuf.', prix: 4500, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 7, images_urls: [], created_at: d, updated_at: d },

  // ── SAUCES GOMBO ────────────────────────────────────────────
  { id: 'd-g01', categorie_id: 'cat-11', nom: 'Sauce gombo enrichie — viande de mouton', slug: 'gombo-mouton', description: 'Sauce gombo enrichie au mouton, crabe, couenne de bœuf et fromage.', prix: 4500, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 1, images_urls: [], created_at: d, updated_at: d },
  { id: 'd-g02', categorie_id: 'cat-11', nom: 'Sauce gombo enrichie — viande de bœuf', slug: 'gombo-boeuf', description: 'Sauce gombo enrichie au bœuf, crabe, couenne de bœuf et fromage.', prix: 6000, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 2, images_urls: [], created_at: d, updated_at: d },
  { id: 'd-g03', categorie_id: 'cat-11', nom: 'Sauce gombo enrichie — viande de poulet', slug: 'gombo-poulet', description: 'Sauce gombo enrichie au poulet, crabe, couenne de bœuf et fromage.', prix: 4500, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 3, images_urls: [], created_at: d, updated_at: d },
  { id: 'd-g04', categorie_id: 'cat-11', nom: 'Sauce gombo enrichie — poisson fumé', slug: 'gombo-poisson-fume', description: 'Sauce gombo enrichie au poisson fumé, crabe, couenne de bœuf et fromage.', prix: 3500, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 4, images_urls: [], created_at: d, updated_at: d },
  { id: 'd-g05', categorie_id: 'cat-11', nom: 'Sauce gombo double viande', slug: 'gombo-double-viande', description: 'Sauce gombo double viande avec crabe, couenne de bœuf, fromage, huile rouge et feuilles de grand morel.', prix: 8000, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 5, images_urls: [], created_at: d, updated_at: d },
  { id: 'd-g06', categorie_id: 'cat-11', nom: 'Sauce gombo enrichie — tripes de mouton', slug: 'gombo-tripes-mouton', description: 'Sauce gombo enrichie aux tripes de mouton.', prix: 5000, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 6, images_urls: [], created_at: d, updated_at: d },
  { id: 'd-g07', categorie_id: 'cat-11', nom: 'Sauce gombo — tripes de bœuf', slug: 'gombo-tripes-boeuf', description: 'Sauce gombo aux tripes de bœuf.', prix: 4500, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 7, images_urls: [], created_at: d, updated_at: d },

  // ── SAUCE ARACHIDE ──────────────────────────────────────────
  { id: 'd-r01', categorie_id: 'cat-12', nom: 'Sauce d’arachide enrichie — viande de mouton', slug: 'arachide-mouton', description: 'Sauce d’arachide enrichie à la viande de mouton et au fromage.', prix: 5000, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 1, images_urls: [], created_at: d, updated_at: d },
  { id: 'd-r02', categorie_id: 'cat-12', nom: 'Sauce d’arachide enrichie — viande de bœuf', slug: 'arachide-boeuf', description: 'Sauce d’arachide enrichie à la viande de bœuf et au fromage.', prix: 5500, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 2, images_urls: [], created_at: d, updated_at: d },
  { id: 'd-r03', categorie_id: 'cat-12', nom: 'Sauce d’arachide enrichie — viande de poulet', slug: 'arachide-poulet', description: 'Sauce d’arachide enrichie à la viande de poulet et au fromage.', prix: 4500, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 3, images_urls: [], created_at: d, updated_at: d },
  { id: 'd-r04', categorie_id: 'cat-12', nom: 'Sauce d’arachide enrichie — poisson fumé et bœuf', slug: 'arachide-poisson-fume-boeuf', description: 'Sauce d’arachide enrichie au poisson fumé, à la viande de bœuf et au fromage.', prix: 6000, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 4, images_urls: [], created_at: d, updated_at: d },
  { id: 'd-r05', categorie_id: 'cat-12', nom: 'Sauce d’arachide enrichie — poisson fumé et mouton', slug: 'arachide-poisson-fume-mouton', description: 'Sauce d’arachide enrichie au poisson fumé, à la viande de mouton et aux fromages.', prix: 5500, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 5, images_urls: [], created_at: d, updated_at: d },
  { id: 'd-r06', categorie_id: 'cat-12', nom: 'Sauce d’arachide — mouton et bœuf', slug: 'arachide-mouton-boeuf', description: 'Sauce d’arachide à la viande de mouton et de bœuf.', prix: 7000, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 6, images_urls: [], created_at: d, updated_at: d },
  { id: 'd-r07', categorie_id: 'cat-12', nom: 'Sauce d’arachide enrichie — tripes de mouton', slug: 'arachide-tripes-mouton', description: 'Sauce d’arachide enrichie aux tripes de mouton.', prix: 5000, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 7, images_urls: [], created_at: d, updated_at: d },
  { id: 'd-r08', categorie_id: 'cat-12', nom: 'Sauce d’arachide enrichie — tripes de bœuf', slug: 'arachide-tripes-boeuf', description: 'Sauce d’arachide enrichie aux tripes de bœuf.', prix: 4500, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 8, images_urls: [], created_at: d, updated_at: d },

  // ── MICHoui MOUTON ──────────────────────────────────────────
  { id: 'd-m01', categorie_id: 'cat-13', nom: 'Michoui de mouton entier', slug: 'michoui-mouton-entier', description: 'Michoui de mouton entier, préparé pour une grande commande.', prix: 85000, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 1, images_urls: [], created_at: d, updated_at: d },
  { id: 'd-m02', categorie_id: 'cat-13', nom: 'Michoui de demi-mouton', slug: 'michoui-demi-mouton', description: 'Michoui de demi-mouton, préparé pour une commande généreuse.', prix: 43000, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 2, images_urls: [], created_at: d, updated_at: d },
  { id: 'd-m03', categorie_id: 'cat-13', nom: 'Michoui de cas de mouton', slug: 'michoui-cas-mouton', description: 'Préparation de mouton selon le format indiqué sur le menu source.', prix: 22000, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 3, images_urls: [], created_at: d, updated_at: d },
  { id: 'd-m04', categorie_id: 'cat-13', nom: 'Michoui de mouton et sauce gbôta', slug: 'michoui-mouton-sauce-gbota', description: 'Michoui de mouton accompagné de sauce gbôta.', prix: 120000, disponible: true, est_vegetarien: false, est_epice: false, est_vedette: false, ordre: 4, images_urls: [], created_at: d, updated_at: d },
